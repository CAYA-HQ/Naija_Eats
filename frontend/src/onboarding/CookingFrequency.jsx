    ...
    >
      ...
      <div className="bg-white/50 rounded-2xl p-5 mb-4">
        ...
        <div className="flex gap-2">
          {householdOptions.map((opt) => (
            ...
            >
              <span className="text-lg font-bold font-inter">{opt.number}</span>
      ...
      <div className="bg-white/50 rounded-2xl p-5 mb-6">
        ...
        <div className="flex items-center justify-between">
          <span className="text-xs font-semibold font-inter text-body">NO</span>
          <button
      ...
      <div className="bg-white/50 rounded-2xl p-5">
        ...
        <ul className="flex flex-col gap-1">
          {frequencyOptions.map((option) => (
            ...
            >
              <CustomCheckbox checked={selectedFrequencies.includes(option)} />
