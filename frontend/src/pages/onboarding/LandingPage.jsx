...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-bg-background text-text-primary flex flex-col font-inter overflow-x-hidden">
      ...
      <section className="bg-text-primary text-white py-16 px-6 md:px-12 w-full text-center flex flex-col items-center gap-8 relative overflow-hidden">
        {/* Visual BG Accents 
        <div className="absolute top-10 left-10 w-48 h-48 bg-white/5 rounded-full blur-3xl pointer-events-none"></div>
        <div className="absolute bottom-10 right-10 w-64 h-64 bg-accent-orange/5 rounded-full blur-3xl pointer-events-none"></div>

        {/* Quotes Icon Accent 
        <span className="text-accent-orange text-8xl font-display leading-[0] select-none">
          “
        </span>

        <blockquote className="max-w-3xl text-xl md:text-3xl font-display font-medium leading-relaxed tracking-tight text-white">
          NaijaEats has made cooking so much easier. I don't need to spend hours
          pondering on what to cook. I just open the plan for the day and get
          cooking
        </blockquote>

        {/* User Card 
        <div className="flex items-center gap-4 mt-4">
          <div className="w-14 h-14 rounded-full overflow-hidden border-2 border-accent-orange/50">
            <img
              src="/images/Avatar.png"
              alt="David O. Chinedu Profile"
          ...
          <div className="text-left flex flex-col">
            ...
            <span className="text-xs font-bold text-accent-orange tracking-widest font-inter">
              FOUNDER & COOK
            </span>
      ...
      {/* 8. Footer */}
      <footer className="mt-auto py-8 border-t border-text-primary/10 bg-bg-background flex flex-col items-center justify-center gap-4 w-full">
        <div className="flex items-center gap-6 text-sm text-text-primary/60 font-semibold font-inter">
        ...
        <span className="text-xs text-text-primary/40 font-inter">
          &copy; 2026 NaijaEats. All rights reserved.
        </span>
      </footer>
    </div>
  );
